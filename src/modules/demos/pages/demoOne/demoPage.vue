<template>
  ...
  <div class="demo-one-perview" v-if="tempName && event.active">
    <div class="demo-one-perview__bg">
      <demoOneHeader
        :className="'demo-one__header'"
        :buttonName="'RSVP Now!'"
      ...
      <annualInfo
        :className="'demo-one__annual-info'"
        :annualInfoDataCardButton="'RSVP Now!'"
        :name="event.name"
        ...
        :aboutClass="'demo-one__annual-info_about'"
        :buttonUrl="currenttPath + '/registration'"
      ></annualInfo>
      <div class="demo-one__speaker-info" v-if="Speakers != ''">
      ...
      <!--  -->
      <div class="demo-one__schedule-info">
        <div class="schedule-info q-pa-md demo-one-two-schedule-info">
          <div class="schedule-info__data">
            <p class="schedule-info__head">THE SCHEDULE</p>
            <div class="schedule-info__data__container">
              <q-card class="demo-one-card demo-one-two-card">
                <q-tabs
                  v-model="tab"
                  dense
      ...
      <!--  -->
      <div class="demo-one__sponsor-info" v-if="sponsorCategories != ''">
        <div class="sponsor-info q-pa-md">
          <div class="sponsor-info__data">
            <p class="sponsor-info__head">Offcial Sponsors & Partners</p>
      ...
      <!--  -->
      <div class="demo-one__exhibitor-info" v-if="Exhibitors != ''">
        <div class="exhibitor-info q-pa-md">
          <div class="exhibitor-info__data">
            <p class="exhibitor-info__head">Offcial Exhibitors</p>
      ...
      <!--  -->
      <div class="demo-one__news-info" v-if="news != ''">
      ...
      <!--  -->
      <footerInfo
        :className="'demo-one__footer-info'"
        :footerButton="'RSVP Now!'"
        :buttonUrl="currenttPath + '/registration'"
      >
      </footerInfo>
    </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const isTemp = () => {
      if (event.value.eventtemplatename == "professional") {
        tempName.value = true;
      } else {
