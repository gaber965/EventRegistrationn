<template>
  <div class="demo-one-perview">
    <div class="demo-one-perview__bg">
      ...
      ></annualInfo>
      <div class="demo-one__speaker-info">
            ...
            <div class="speaker-info__data-details">
              <div class="row speaker-info__data__container">
                <speakerInfo
                  v-for="item in 8"
                  :key="item"
                  :classSocial="'demo-one__socialMedia'"
                ></speakerInfo>
              </div>
            </div>
          </div>
      ...
      <div
        class="schedule-info q-pa-md demo-one-two-schedule-info demo-one__schedule-info"
      >
      ...
      <div class="demo-one__sponsor-info">
      ...
      <div class="demo-one__exhibitor-info">
